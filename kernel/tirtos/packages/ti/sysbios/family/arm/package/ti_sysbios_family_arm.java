...
public class ti_sysbios_family_arm
{
    ...
    void Settings$$TYPES()
    {
        ...
        if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
                ...
                if (fxn != null) po.addFxn("getDefaultSysCallDelegate", (Proto.Fxn)om.findStrict("ti.sysbios.interfaces.ISettings$$getDefaultSysCallDelegate", "ti.sysbios.family.arm"), fxn);
